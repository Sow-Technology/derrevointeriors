...
const Navbar = () => {
  return (
    <div className="flex justify-between items-center mx-auto max-w-7xl py-5 px-7">
      ...
      <div className="flex flex-col items-end gap-[26px] ">
        ...
        <div className="text-[#4A4A4A] text-[13px] font-[500] leading-[22px] tracking-[-0.12px] gap-[25px] flex lato-med">
          {NavItem.map((item) => (
            <Link
              href={item.link}
              key={item.name}
