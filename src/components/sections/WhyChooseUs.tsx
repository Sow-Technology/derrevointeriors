...
const WhyChooseUs = () => {
  return (
    <div className="flex flex-col items-center justify-center max-w-7xl my-10 mx-auto px-[25px] md:px-[73px] py-10">
      <div className="text-[#222] text-[24px] font-bold leading-[24px] mb-10">
        <h3>Why Choose Us</h3>
      </div>
      <div className="flex items-center justify-center gap-[15px] md:justify-between w-full flex-wrap">
        {ChooseItem.map((item) => (
          <div
            key={item.title}
